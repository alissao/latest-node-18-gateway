...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.ecommerce.melilike.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.ecommerce.melilike.security.DomainUserDetailsService", "createSpringSecurityUser");
